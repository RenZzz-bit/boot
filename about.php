        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                <a href="index.php" class="navbar-brand">
                    <h1 class="" style="color: #FF5733;"></span>KAAGAPAY</h1>
                </a>
        ...
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                <div class="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                    <h1 class="display-4 mb-4 animated slideInRight" style="color: #FF5733;">About Us</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center justify-content-lg-start mb-0">
                            <li class="breadcrumb-item"><a class="" href="#" style="color: #FF5733;">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page" style="color: #FF5733;">About Us</li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h1 class="mb-4" style="color: #FF5733;">What we Offer?</h1>
                    <p class="mb-4"  style="color: #FF5733;">KAAGAPAY is an online platform created to support and connect overseas Filipino workers (OFWs). It provides essential resources such as legal assistance, emergency aid, and up-to-date news, while also allowing users to share experiences and interact with one another. The platform aims to create a secure
                         and accessible space where OFWs can connect, find critical information, and support their community.</p>
                    <!-- <div class="row g-3">
                        <div class="col-sm-6">

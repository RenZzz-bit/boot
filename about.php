        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">KAAGAPAY is an online platform created to support and connect overseas Filipino workers (OFWs). It provides essential resources such as legal assistance, emergency aid, and up-to-date news, while also allowing users to share experiences and interact with one another. The platform aims to create a secure
